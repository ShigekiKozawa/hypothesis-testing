...
export default function Section1_GraphReading_1() {
  const questions: Question[] = [
    ...
    {
      id: 9,
      question: "下のヒストグラムは、あるクラスの小テスト（20点満点）の結果です。このヒストグラムの形状として最も適切な記述はどれですか。\n\n階級の度数：\n0-5点: 2人\n5-10点: 3人\n10-15点: 8人\n15-20点: 17人",
      options: [
        "左右対称である",
        "右に裾を引いている（正の歪度）",
        "左に裾を引いている（負の歪度）",
      ...
      correct: 3,
      explanation: "度数が高得点側（右側）に偏っており、低得点側（左側）に裾を引いている分布です。これは負の歪度（左に歪んだ分布）を持つと言えます。",
      chartType: 'histogram',
      barData: [
    ...
    {
      id: 10,
      question: "2つの箱ひげ図を比較したとき、次の記述のうち誤っているものはどれですか。\n\nデータA: 最小値20、Q1=40、中央値50、Q3=60、最大値80\nデータB: 最小値30、Q1=50、中央値60、Q3=70、最大値90",
      options: [
        "データBの方が全体的に値が大きい",
        "データAとデータBの四分位範囲は同じである",
        "データBの方が範囲が大きい",
