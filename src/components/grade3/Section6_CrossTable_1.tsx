  ...
  const questions: Question[] = [
    {
      ...
      chartType: 'bar',
      barData: [
        { category: '男性購入', value: 30 },
        { category: '女性購入', value: 40 },
        { category: '購入者合計', value: 70 }
      ],
      chartLabels: { x: '', y: '人数' }
    },
    {
    ...
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: '両方飲む', value: 20 },
        { category: 'コーヒーのみ', value: 30 }
      ],
      chartLabels: { x: '', y: '人数' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: 'カテゴリA', value: 40 },
        { category: 'カテゴリB', value: 60 }
      ],
      chartLabels: { x: '', y: '度数' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: '女性好き', value: 25 },
        { category: '女性普通', value: 15 },
        { category: '女性嫌い', value: 10 }
      ],
      chartLabels: { x: '', y: '人数' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: '両方する', value: 40 },
        { category: 'テニスのみ', value: 60 },
        { category: '水泳のみ', value: 30 },
        { category: '両方しない', value: 70 }
      ],
      chartLabels: { x: '', y: '人数' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: 'A女性割合', value: 40 },
        { category: 'B女性割合', value: 50 },
        { category: 'C女性割合', value: 67 }
      ],
      chartLabels: { x: '', y: '割合(%)' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: '行1合計', value: 50 },
        { category: '行2合計', value: 50 },
        { category: '列1合計', value: 60 },
        { category: '列2合計', value: 40 }
      ],
      chartLabels: { x: '', y: '度数' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: 'スマホのみ', value: 50 },
        { category: 'タブレットのみ', value: 30 },
        { category: '両方', value: 40 },
        { category: 'どちらも×', value: 30 }
      ],
      chartLabels: { x: '', y: '人数' }
    },
    {
      ...
      chartType: 'bar',
      barData: [
        { category: '20代', value: 30 },
        { category: '30代', value: 50 },
        { category: '40代', value: 60 }
      ],
      chartLabels: { x: '年代', y: '満足度高の割合(%)' }
    }
  ];
