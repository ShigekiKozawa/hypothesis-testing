...
export default function Grade3Section8Set2() {
  ...
  const questions = [
    {
        ...
        correct: 2,
        explanation: "時系列データと指数の基本的な内容です。"
    },
    {
        id: 2,
        question: "時系列データと指数に関する問題2です。",
        options: [
            "選択肢1",
            "選択肢2（正解）",
            "選択肢3",
  ...
  useEffect(() => {
    const best = getBestScore('grade3-section8_multivariate_2');
    if (best) {
