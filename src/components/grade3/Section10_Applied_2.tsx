...
export default function Grade3Section10Set2() {
  ...
  const questions = [
    {
        ...
        correct: 2,
        explanation: "推測統計の入口の基本的な内容です。"
    },
    {
        id: 2,
        question: "推測統計の入口に関する問題2です。",
        options: [
            "選択肢1",
            "選択肢2（正解）",
            "選択肢3",
  ...
  useEffect(() => {
    const best = getBestScore('grade3-section10_applied_2');
    if (best) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 mb-2">点推定と区間推定の基本的な考え方を学びます</p>
