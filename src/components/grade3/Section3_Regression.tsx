...
export default function Grade3Section3() {
  ...
  const questions = [
    {
      id: 1,
      question: "回帰直線 y = 2x + 3 において、x = 5 のときの y の予測値はいくつですか。",
      options: ["8", "10", "13", "15"],
      correct: 3,
      explanation: "回帰直線の式に x = 5 を代入します。y = 2 × 5 + 3 = 10 + 3 = 13です。"
    },
    {
      id: 2,
      question: "決定係数R²が0.81の場合、このモデルについて正しい説明はどれですか。",
      options: [
        "モデルは全く説明力がない",
        "モデルはデータの約81%を説明している",
        "モデルはデータの約19%を説明している",
      ...
      correct: 2,
      explanation: "決定係数R²は、モデルがデータの変動をどれだけ説明できるかを示します。R²=0.81は、モデルがデータの約81%の変動を説明していることを意味します。"
    },
    {
      id: 3,
      question: "決定係数R²の値の範囲として正しいものはどれですか。",
      options: [
        "-1以上1以下",
        "0以上1以下",
        "0より大きく1より小さい",
      ...
      correct: 2,
      explanation: "決定係数R²は0以上1以下の値をとります。0に近いほどモデルの説明力が低く、1に近いほど説明力が高いことを示します。"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600">回帰直線と決定係数を理解しましょう</p>
        </div>
