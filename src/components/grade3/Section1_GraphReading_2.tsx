...
export default function Section1_GraphReading_2() {
  const questions: Question[] = [
    ...
    {
      id: 2,
      question: "次の度数分布表において、第1四分位数（Q1、25パーセンタイル）が含まれる階級はどれですか。\n\n階級 | 度数\n0-10 | 5\n10-20 | 10\n20-30 | 15\n30-40 | 12\n40-50 | 8\n合計 | 50",
      options: ["0-10", "10-20", "20-30", "30-40"],
      correct: 2,
      explanation: "第1四分位数は累積相対度数0.25の位置、つまり50人の25%=12.5番目の値です。累積度数：0-10で5人、0-20で15人。12.5番目は10-20の階級に含まれます。",
      chartType: 'histogram',
      barData: [
    ...
    {
      id: 4,
      question: "あるデータセット（10個）の観測値の2乗和が2500、平均が12のとき、分散はいくつですか。\n\n※分散の公式：分散 = (観測値の2乗和 / n) - (平均値)²",
      options: ["100", "106", "144", "250"],
      correct: 2,
      explanation: "分散 = (観測値の2乗和 / n) - (平均値)² = 2500/10 - 12² = 250 - 144 = 106です。この公式は計算の効率化に役立ちます。",
      chartType: 'bar',
      barData: [
        { category: '5', value: 2 },
        { category: '10', value: 3 },
