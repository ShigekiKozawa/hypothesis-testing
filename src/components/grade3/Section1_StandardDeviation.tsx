...
export default function Grade3Section1() {
  ...
  const questions = [
    {
      ...
      options: ["4", "6", "8", "10"],
      correct: 3,
      explanation: "分散 = {(2-6)² + (4-6)² + (6-6)² + (8-6)² + (10-6)²} ÷ 5 = (16 + 4 + 0 + 4 + 16) ÷ 5 = 40 ÷ 5 = 8です。"
    },
    {
      id: 2,
      question: "分散が25のデータの標準偏差はいくつですか。",
      options: ["3", "5", "10", "25"],
      correct: 2,
      explanation: "標準偏差は分散の平方根です。√25 = 5です。"
    },
    {
      id: 3,
      question: "2つのデータA: 平均50、標準偏差10とB: 平均50、標準偏差5について、どちらのデータがよりばらついていますか。",
      options: [
        "Aの方がばらついている",
        "Bの方がばらついている",
        "同じくらいばらついている",
      ...
      correct: 1,
      explanation: "標準偏差が大きいほどデータがばらついています。Aの標準偏差（10）の方がBの標準偏差（5）より大きいので、Aの方がばらついています。"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600">データの散らばりを表す標準偏差と分散を理解しましょう</p>
        </div>
