...
export default function Section5_Inference_2() {
  const questions: Question[] = [
    ...
    {
      id: 4,
      question: "新しい勉強法の効果を検証する実験で、p値が0.08と計算されました。有意水準5%で検定を行う場合、どう判断されますか。",
      options: [
        "帰無仮説を棄却する",
        "帰無仮説を棄却しない",
        "有意水準を10%に変更する",
      ...
      correct: 2,
      explanation: "p値(0.08) > 有意水準(0.05)なので、帰無仮説を棄却しません。勉強法に統計的に有意な効果があるとは言えません。"
    },
    {
      id: 5,
    ...
    {
      id: 8,
      question: "品質改善の効果を検証する実験で、p値が0.12と計算されました。有意水準10%で検定を行う場合、どう判断されますか。",
      options: [
        "帰無仮説を棄却する",
        "帰無仮説を棄却しない",
        "有意水準を5%に変更する",
      ...
      correct: 2,
      explanation: "p値(0.12) > 有意水準(0.10)なので、帰無仮説を棄却しません。品質改善に統計的に有意な効果があるとは言えません。"
    },
    {
      id: 9,
