...
export default function Grade4Section2() {
  ...
  const questions = [
    {
      id: 1,
      question: "次のデータの範囲（レンジ）を求めなさい。\nデータ: 18, 25, 12, 30, 22, 15",
      options: ["15", "18", "20", "22"],
      correct: 2,
      explanation: "範囲（レンジ）= 最大値 - 最小値 = 30 - 12 = 18です。"
    },
    {
      id: 2,
      question: "次のデータを小さい順に並べたとき、第1四分位数（Q1）はいくつですか。\nデータ: 4, 7, 9, 11, 13, 15, 18, 20",
      options: ["7", "8", "9", "10"],
      correct: 2,
      explanation: "データを小さい順に並べると: 4, 7, 9, 11, 13, 15, 18, 20。8個のデータの下位25%の位置は2.25番目なので、2番目の7と3番目の9の間を補間して、(7 + 9) ÷ 2 = 8です。"
    },
    {
      id: 3,
      question: "あるクラスのテストの点数の第3四分位数（Q3）が80点、第1四分位数（Q1）が60点でした。四分位範囲（IQR）はいくつですか。",
      options: ["10点", "15点", "20点", "25点"],
      correct: 3,
      explanation: "四分位範囲（IQR）= Q3 - Q1 = 80 - 60 = 20点です。"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600">範囲と四分位範囲の理解を深めましょう</p>
        </div>
