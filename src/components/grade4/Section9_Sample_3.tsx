  ...
  const questions = [
    {
        ...
        correct: 2,
        explanation: "サンプリング方法の基本的な内容を確認する問題です。"
    },
    {
        id: 2,
        question: "サンプリング方法に関する問題2です。",
        options: [
            "選択肢1",
            "選択肢2（正解）",
            "選択肢3",
