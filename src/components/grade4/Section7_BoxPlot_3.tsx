  ...
  const questions = [
    {
        ...
        correct: 2,
        explanation: "外れ値の基本的な内容を確認する問題です。"
    },
    {
        id: 2,
        question: "外れ値に関する問題2です。",
        options: [
            "選択肢1",
            "選択肢2（正解）",
            "選択肢3",
