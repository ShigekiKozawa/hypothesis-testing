...
- 具体的な数値データを提示し、平均値、中央値、標準偏差などを計算させる問題
- グラフと表を組み合わせて読み取らせる問題

# 良い問題の例（参考にすべきパターン）

【例1：グラフから読み取る問題（最も推奨）】✅
問題文: 「下のヒストグラムは、あるクラスのテストの点数分布を示しています。中央値が含まれる階級はどれですか。」
...
3. 80-90点
4. 90-100点
解説: 「全体の人数が30人で、中央値は15番目と16番目の平均です。累積度数を見ると...」

【例2：データから計算する問題（推奨）】✅
問題文: 「次の5人のテスト点数について、平均値を求めなさい。データ：{60, 70, 80, 85, 85}」
選択肢:
1. 72点
2. 76点 ✓（正解）
3. 80点
4. 82点
解説: 「平均値 = (60+70+80+85+85) ÷ 5 = 380 ÷ 5 = 76点」

【例3：散布図から読み取る問題（最も推奨）】✅
問題文: 「下の散布図は、勉強時間と成績の関係を示しています。この散布図から読み取れる相関は次のうちどれですか。」
...
3. 相関なし
4. 負の相関
解説: 「散布図は右上がりの傾向を示しており、正の相関があります。ただし点のばらつきが大きいため...」
